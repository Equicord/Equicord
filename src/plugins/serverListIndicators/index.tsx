...
function FriendsIndicator() {
    ...
    return (
        <div id="vc-friendcount">
            ...
            <BaseText size="xs" id="vc-friendcount-text">
                {onlineFriendsCount}
            </BaseText>
            {!!settings.store.useCompact && (
                <BaseText size="xs" id="vc-friendcount-text-compact">
                    Friends
                </BaseText>
            )}
        </div>
...
function ServersIndicator() {
    ...
    return (
        <div id="vc-guildcount">
            ...
            <BaseText size="xs" id="vc-guildcount-text">
                {guildCount}
            </BaseText>
            {!!settings.store.useCompact && (
                <BaseText size="xs" id="vc-guildcount-text-compact">
                    Servers
                </BaseText>
            )}
        </div>
                ...
                <div id={cl("container")}>
                    <Tooltip text={text} position="right">
                        {({ onMouseEnter, onMouseLeave }) => (
                            <div id={cl("indicator-items")} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
