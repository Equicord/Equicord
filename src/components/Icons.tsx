...
export function EquicordIcon(props: IconProps) {
    return (
        ...
        >
            <path
                fill={props.fill || "currentColor"}
                d="M220.7,442.46c-58.95,0-114.37-22.96-156.06-64.64C22.96,336.14,0,280.71,0,221.76S22.96,107.39,64.64,65.7C106.33,24.02,161.75,1.06,220.7,1.06s114.37,22.96,156.06,64.64,64.64,97.11,64.64,156.06-22.96,114.37-64.64,156.06c-41.68,41.68-97.11,64.64-156.06,64.64ZM220.7,78.65c-78.61,0-142.56,63.95-142.56,142.56s63.95,142.56,142.56,142.56,142.56-63.95,142.56-142.56-63.95-142.56-142.56-142.56ZZ"
            />
            <path
                fill={props.fill || "currentColor"}
