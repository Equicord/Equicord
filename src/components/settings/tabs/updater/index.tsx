...
function Updater() {
    ...
    return (
        <SettingsTab title="Xehcord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Xehcord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Xehcord automatically updates"
