...
import { Devs, OutcordDevs } from "@utils/constants";
import definePlugin, { makeRange, OptionType } from "@utils/types";
import type { Channel } from "@vencord/discord-types";
import { GuildChannelStore, GuildStore, Menu, PermissionsBits, PermissionStore, React, RestAPI, UserStore, VoiceStateStore } from "@webpack/common";
    ...
    children.splice(
        ...
        >
            <Menu.MenuItem
                ...
                disabled={!PermissionStore.can(PermissionsBits.MOVE_MEMBERS, channel)}
            />
            ...
            <Menu.MenuItem
                ...
                disabled={!PermissionStore.can(PermissionsBits.MUTE_MEMBERS, channel)}
            />
            ...
            <Menu.MenuItem
                ...
                disabled={!PermissionStore.can(PermissionsBits.DEAFEN_MEMBERS, channel)}
            />
            ...
            {(
                PermissionStore.can(PermissionsBits.MOVE_MEMBERS, GuildStore.getGuild(channel.guild_id)) ||
                ...
                >
                    {PermissionStore.can(PermissionsBits.MOVE_MEMBERS, GuildStore.getGuild(channel.guild_id))
                        ...
                        : voiceChannels.filter((c) => PermissionStore.can(PermissionsBits.MOVE_MEMBERS, c)).map((voiceChannel) => {
                            return (
                                <Menu.MenuItem
                                    key={voiceChannel.id}
                                    id={voiceChannel.id}
...
export default definePlugin({
    ...
    authors: [Devs.D3SOX, OutcordDevs.Out],
