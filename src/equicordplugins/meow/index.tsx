...
const settings = definePluginSettings(
    {
        meowButton: {
            ...
            description: "Addes a chatbar button that sends 'meow'",
            default: true,
            restartNeeded: true,
        }
    }, {
...
const meowToggle: ChatBarButton = ({ isMainChat }) => {
    const { meowButton } = settings.use(["meowButton"]);

    if (!isMainChat || !meowButton) return null;
...
export default definePlugin({
    ...
    settings,
    start() {
        addChatBarButton("Meow", meowToggle);
    },
    stop:() => {
        removeChatBarButton("Meow");
    },
