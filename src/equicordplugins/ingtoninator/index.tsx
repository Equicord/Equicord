            ...
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                ...
                {isEnabled && (
                    <>
                        ...
                        <path fill="var(--status-danger)" d="m21.178 1.70703 1.414 1.414L4.12103 21.593l-1.414-1.415L21.178 1.70703Z" transform="translate(0 0)" />
                    </>
                )}
            </svg>
        </ChatBarButton>
