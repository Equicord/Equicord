...
const settings = definePluginSettings(
    {
        woofButton: {
            ...
            description: "Addes a chatbar button that sends 'Bark'",
            default: true,
            restartNeeded: true,
        }
    }, {
...
const woofToggle: ChatBarButton = ({ isMainChat }) => {
    const { woofButton } = settings.use(["woofButton"]);

    if (!isMainChat|| !woofButton) return null;
...
export default definePlugin({
    ...
    start: () => {
        addChatBarButton("Woof", woofToggle);
    },
    stop:() => {
        removeChatBarButton("Woof");
    },
