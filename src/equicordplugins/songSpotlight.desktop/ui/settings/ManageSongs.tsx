...
import { UserData, UserDataSchema } from "@equicordplugins/songSpotlight.desktop/lib/ssapi/structs";
import { sid } from "@equicordplugins/songSpotlight.desktop/lib/ssapi/util";
import { useAuthorizationStore } from "@equicordplugins/songSpotlight.desktop/lib/store/AuthorizationStore";
...
function ImportButton({ overwrite, pending, setPending, onImport }: ImportButtonProps) {
    const checkClipboard = useCallback(async () => {
        ...
        let json: any;
        try {
            json = JSON.parse(await readClipboardText());
        } catch {
            setPending(false);
