Fork to upload plugins. All credit is given within the source code. Plugins are uploaded @ `/src/plugins`.

These are some plugins we have added: `CompactDMHeader, IdleLowPowerMode, SilentMentionCleaner, antiTrack, silentfolder, optimizer, hider, vcplugin, link preview, messagePurger`.

Feel free to check them out and change their names if needed :>. Have a good one.
